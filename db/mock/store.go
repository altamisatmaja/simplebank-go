...
// Source: github.com/altamisatmaja/simplebank-go/db/sqlc (interfaces: Store)
...
func (m *MockStore) TransferTx(arg0 context.Context, arg1 db.TransfersTxParams) (db.TransfersTxResults, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransferTx", arg0, arg1)
	ret0, _ := ret[0].(db.TransfersTxResults)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
